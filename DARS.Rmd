...
df$dx <- sample(c('HC', 'MDD'), size=nrow(df), replace=T)

#add a column with fake sex (M, F, O)

#add a column with fake age (60-80)
...
ratings_vars <- grep("ratings", names(df), value=TRUE) #it looks like we have 5 ratings for sensory - make sure this is correct
...
#check t-test assumptions: are the data normally distributed?
