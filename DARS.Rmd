...
#create new column in df - dars_age_category
...
#Within each group of subjects (MDD, HC, female, male, young, old), we are trying to compare the mean total rating score for hobbies to mean total rating score for foods; #the mean total rating score for hobbies to mean total rating score for social; 
